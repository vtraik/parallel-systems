...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.8\linewidth]{graphs/speedup_pthreadsb_vs_openmp_pol.png}
    \caption{\en{Speedup: Pthreads (+blocking) / Openmp (+simd)}}
\end{figure}
...
Η υλοποίηση με \en{Openmp} είναι $\backsim  20\%$ πιο γρήγορη από αυτήν με \en{Pthreads}. Αυτό οφείλεται κυρίως  
στη παράλληλη εκτέλεση του εσωτερικού βρόχου μεγέθους $k$ (μέσω της οδηγίας \en{omp simd}), 
όπου για μεγάλα πολυώνυμα προσφέρει την επιτάχυνση (έναντι της μη χρήσης της) περίπου ενός δευτερολέπτου.
